...
**BashKeeper - это мощный инструмент, предназначенный для автоматизации Linux-систем, работающий на любом дистриубтиве с любым пакетным менджером💨**
...
**BaskKeeper** - Инструмент для автоматизации рутиных вещей в Linux-Системах, написанный на Bash 🎯
...
```
git clone https://github.com/DenisEx8loit/BashKeeper.git
cd BashKeeper
```
